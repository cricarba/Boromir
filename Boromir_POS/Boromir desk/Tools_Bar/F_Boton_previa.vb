        ...
        Try
            ...
            Select Case app
                ...
                Case "Cotizaciones"
                    ...
                    Vista_Previa.ReportViewer1.LocalReport.DataSources.Clear()
                    Dim ds As New DataSet()
                    Variables.sSel = "Select nprecio_venta_produ,ncod_produ_detmovim,cnombre_produ,ncantidad_detmovim ,nprecio_detmovim,ncod_ubica_detmovim,nimpuesto_detmovim,ndescuento_detmovim,nneto_cotiz,ndescuento_cotiz,nimpuesto_cotiz,ntotal_cotiz,ncodigo_cotiz, ccod_conce_cotiz,ffecha_cotiz,ncod_movim_detmovim,ccodigo_conce,ncod_ubic_cotiz,cnombre_ubica,cnombre_conce from tbl_cotizaciones,tbl_detalle_movimientos,tbl_productos,tbl_conceptos,tbl_ubicaciones where  ncodigo_cotiz =  '" & Cotizaciones.TxtFactura_factu.Text & "' and ccod_conce_cotiz =  '" & Cotizaciones.CBConcepto.Text & "' and ncod_ubic_cotiz = '" & Cotizaciones.CBUbicacion.Text & "' and   ncod_movim_detmovim = ncodigo_cotiz and ccod_conce_detmovim = ccod_conce_cotiz and ncod_ubic_cotiz = ncod_ubica_detmovim and ccodigo_conce = ccod_conce_cotiz and ncod_produ_detmovim = ncodigo_produ and ncodigo_ubica = ncod_ubic_cotiz"
                    Variables.da = (New SqlDataAdapter(sSel, sCnn))
                    Variables.da.Fill(ds)
                    Dim data1 As New ReportDataSource("DataSet1", ds.Tables(0))
                    Vista_Previa.ReportViewer1.LocalReport.DataSources.Add(data1)
                    ...
                    Dim data2 As New ReportDataSource("Empresa", de.Tables(0))
                    Vista_Previa.ReportViewer1.LocalReport.DataSources.Add(data2)
                    Vista_Previa.ReportViewer1.LocalReport.EnableExternalImages = True
    ...
    Public Sub carga_reporte()
        ...
        Try
            Select Case Variables.nombre_report
                ...
                Case "Costo Producto X Proveedor"
                    Dim listparamter As New List(Of ReportParameter)
                    Reporteador.ReportViewer1.ProcessingMode = ProcessingMode.Local
                    Reporteador.ReportViewer1.LocalReport.ReportPath = carpeta_reportes & "\r_inv_costo_produc.rdlc"
                    Reporteador.ReportViewer1.LocalReport.DataSources.Clear()
                    consulta = "SELECT  tbl_movimiento_producto.ncodigo_moviprodu  ,tbl_movimiento_producto.ccod_conce_moviprodu  ,tbl_movimiento_producto.ncod_ubica_moviprodu ,tbl_movimiento_producto.ffecha_moviprodu ,tbl_movimiento_producto.ncod_terce_moviprodu ,tbl_terceros.ncodigo_terce ,tbl_terceros.cnombre_terce ,tbl_terceros.cnombre2_terce ,tbl_terceros.capellido_terce,tbl_terceros.capellido2_terce,tbl_productos.ncodigo_produ,tbl_productos.cnombre_produ,tbl_detalle_movimientos.ncod_movim_detmovim,tbl_detalle_movimientos.ccod_conce_detmovim,tbl_detalle_movimientos.ncod_ubica_detmovim,tbl_detalle_movimientos.ncod_produ_detmovim,tbl_movimiento_producto.ccod_estad_moviprodu,tbl_detalle_movimientos.nprecio_detmovim,tbl_detalle_movimientos.ndescuento_detmovim,tbl_detalle_movimientos.nimpuesto_detmovim FROM  tbl_movimiento_producto, tbl_detalle_movimientos,tbl_terceros, tbl_productos where tbl_detalle_movimientos.ncod_movim_detmovim = tbl_movimiento_producto.ncodigo_moviprodu and tbl_movimiento_producto.ncod_ubica_moviprodu = tbl_detalle_movimientos.ncod_ubica_detmovim and tbl_movimiento_producto.ccod_conce_moviprodu = tbl_detalle_movimientos.ccod_conce_detmovim and tbl_movimiento_producto.ncod_terce_moviprodu = tbl_terceros.ncodigo_terce and tbl_detalle_movimientos.ncod_produ_detmovim = tbl_productos.ncodigo_produ"
                    filtro = F_Filtros_Reportes.filtros_inventarios()
                    If filtro <> "" Then
                ...
                Case "Movimientos Facturacion"
                    ...
                    Reporteador.ReportViewer1.LocalReport.DataSources.Clear()
                    consulta = "SELECT cnombre_empre,nnit_empre,cdireccion_empre,ntelefono_empre,ncod_movim_detmovim,tbl_detalle_movimientos.ccod_conce_detmovim,tbl_detalle_movimientos.ncod_ubica_detmovim,tbl_detalle_movimientos.ffecha_detmovim,tbl_detalle_movimientos.ncod_produ_detmovim,tbl_detalle_movimientos.ncantidad_detmovim,tbl_detalle_movimientos.nprecio_detmovim,tbl_detalle_movimientos.ndescuento_detmovim,tbl_detalle_movimientos.nimpuesto_detmovim,tbl_facturas.ncodigo_factu,tbl_facturas.ccod_conce_factu,tbl_facturas.ncod_ubic_factu,tbl_facturas.ncod_terce_factu,tbl_facturas.ffecha_factu,tbl_facturas.nneto_factu,tbl_facturas.ndescuento_factu,tbl_facturas.nimpuesto_factu,tbl_facturas.ntotal_factu,tbl_facturas.ccod_estad_factu,tbl_productos.ncodigo_produ,tbl_productos.ncod_externo_produ,tbl_productos.cnombre_produ,tbl_productos.ccod_categ_produ,tbl_productos.ccod_marca_produ,tbl_productos.ccod_und_produ,tbl_productos.nimpuesto_produ,tbl_productos.ndescuento_produ,tbl_productos.nprecio_compra_produ,tbl_productos.nprecio_venta_produ,tbl_conceptos.ccodigo_conce,tbl_conceptos.cnombre_conce FROM tbl_facturas,tbl_conceptos,tbl_detalle_movimientos ,tbl_productos,tbl_empresa"
                    filtro = F_Filtros_Reportes.filtros_facturacion()
                    If filtro <> "" Then
                        consulta = consulta & " where 1 = 1 AND tbl_conceptos.ccodigo_conce = tbl_facturas.ccod_conce_factu  AND tbl_conceptos.ccodigo_conce = tbl_detalle_movimientos.ccod_conce_detmovim AND tbl_productos.ncodigo_produ = tbl_detalle_movimientos.ncod_produ_detmovim and ncod_movim_detmovim = ncodigo_factu and ccod_estad_factu =" & filtro
                    End If
                    Dim de As New DataSet()
                    Variables.sSel = consulta
                    Variables.da = (New SqlDataAdapter(sSel, sCnn))
