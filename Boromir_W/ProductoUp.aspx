...
<body>
    ...
    <section class="popup">
     ...
     <section class="popup">
         Cod: <asp:Label ID="Lbnombre" runat="server" Text=""></asp:Label>
         <p></p>
         <asp:Label ID="Lbcodigo" runat="server" Text=""></asp:Label>
         <p></p>
         <asp:Label ID="Lbcategoria" runat="server" Text=""></asp:Label>
         <p></p>
    </section>
    <section class="popup">         
         $ <asp:Label ID="lbprecio" runat="server" Text=""></asp:Label>
         <p></p>
         IVA: <asp:Label ID="Lbiva" runat="server" Text="nombre"></asp:Label> %
         <p></p>
         Desc. <asp:Label ID="Lbdescuento" runat="server" Text="nombre"></asp:Label> %
         <p></p>
     </section>
      <section class="popup">         
