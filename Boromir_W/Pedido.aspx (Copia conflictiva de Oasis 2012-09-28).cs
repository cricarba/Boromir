...
namespace Boromir_W
{
    public partial class Pedido : System.Web.UI.Page
    {
        ...
        protected void Confirmar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string comando2 = "exec proc_detalles_movimientos '" + ncodigo_pedid + "','PD',10000,'" + tercero.Rows[0][1].ToString() + "','" + DateTime.Now.ToString() + "',3,34800,1600,0,'agregar'";
